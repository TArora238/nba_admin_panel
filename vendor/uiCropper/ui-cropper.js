    ...
    angular.module('uiCropper').directive('uiCropper', ['$timeout', 'cropHost', 'cropPubSub', function($timeout, CropHost, CropPubSub) {
        return {
            ...
            scope: {
                ...
                minCanvasDimensions: '=?',
                canvasScalemode: '@?',
                /* String. If set to 'full-width' the directive uses all width available */
                ...
                /* Boolean: If true the areaInitCoords and areaInitSize is scaled according to canvas size. */
